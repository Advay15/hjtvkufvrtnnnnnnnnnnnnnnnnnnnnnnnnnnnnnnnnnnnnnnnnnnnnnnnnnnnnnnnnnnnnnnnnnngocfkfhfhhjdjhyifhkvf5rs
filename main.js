//https://teachablemachine.withgoogle.com/models/zJgnQWY6b/
prediction_1="";
prediction_2="";
Webcam.set({
    width: 350,
...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/zJgnQWY6b/model.json', modelLoaded);
